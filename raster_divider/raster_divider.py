...
class RasterDivider:
    ...
    def checkControl(self):
        if any([self.dlg.chb_createOverview.isChecked(), self.dlg.chb_createChunk.isChecked()]):
            ...
            self.dlg.chb_addToMap.setChecked(False)
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            if any([
                ...
                self.dlg.setWindowIcon(QIcon(':/plugins/easy_raster_splitter/ataturkey.png'))
            ...
            self.dlg.chb_createOverview.stateChanged.connect(self.checkControl)
            self.dlg.chb_createChunk.stateChanged.connect(self.checkControl)
        ...
        if result:
            ...
            if self.dlg.chb_addToMap.isChecked():
                ...
                path_vector = fr"{out_folder}\footprints.shp" 
